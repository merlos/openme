---
title: "Handshake"
description-meta: "Step-by-step walkthrough of the openme one-sided knock handshake — client packet construction, server verification, and firewall rule insertion."
keywords-meta: [openme handshake, SPA knock flow, client server knock, firewall rule insert, UDP knock verification, one-sided handshake]
---
