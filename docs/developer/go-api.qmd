...
keywords-meta: [openme Go API, openme Go package, SPA Go library, pkgsite, golang knock protocol]
---
...
mode and places the output in `docs/api/generated/`, which Quarto then links to:
